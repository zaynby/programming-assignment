...
def show_information(player):
    ...
    print(f'Steps taken: {TURNS_PER_DAY - player['turns']}')
    print('------------------------------')
    return
...
def portal_stone():
    if player['bag_capacity'] != player['current_load']:
        print("-----------------------------------------------------")
        print("-")
...
def mining_info():
    ...
    print(f"Turns Left: {player['turns']}          Load: {player['current_load']}/{player['bag_capacity']}          steps: {TURNS_PER_DAY - player['turns']}")
    print("(WASD) to move")
